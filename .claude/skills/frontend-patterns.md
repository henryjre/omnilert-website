...
Available namespaces: `/pos-verification`, `/pos-session`, `/employee-shifts`, `/employee-verifications`, `/employee-requirements`, `/notifications`, `/store-audits`
...
- **Human Resources** (collapsible): Employee Profiles, Employee Schedule, Employee Requirements
