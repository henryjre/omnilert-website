...
const ADMINISTRATOR_DEFAULT_PERMISSIONS = Object.values(PERMISSIONS).filter(
  (permission) => permission !== PERMISSIONS.ACCOUNT_MANAGE_EMPLOYEE_REQUIREMENTS,
);

export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  [SYSTEM_ROLES.ADMINISTRATOR]: ADMINISTRATOR_DEFAULT_PERMISSIONS,
