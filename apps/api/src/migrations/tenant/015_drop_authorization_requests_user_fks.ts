...
const TABLE_NAME = 'authorization_requests';
const USER_CONSTRAINT = 'authorization_requests_user_id_foreign';
const REVIEWED_BY_CONSTRAINT = 'authorization_requests_reviewed_by_foreign';
