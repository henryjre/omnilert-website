...
export async function superList(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function superCreate(req: Request, res: Response, next: NextFunction) {
  try {
    const { companyId } = req.params;
    const tenantDb = db.getDb();
    const { name, address, odooBranchId, isMainBranch } = req.body;
...
export async function superUpdate(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function superRemove(req: Request, res: Response, next: NextFunction) {
  try {
    const { companyId, branchId } = req.params;
    const tenantDb = db.getDb();
