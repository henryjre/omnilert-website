...
import { PayrollManagementPage } from '@/features/payslips/pages/PayrollManagementPage';
...
import { AicVariancePage } from '@/features/aic-variance/pages/AicVariancePage';
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: 'aic-variance',
            element: (
              <PermissionGuard permission={PERMISSIONS.AIC_VARIANCE_VIEW}>
                <AicVariancePage />
              </PermissionGuard>
            ),
          },
