...
const PERMISSION_NAME_OVERRIDES: Partial<Record<string, string>> = {
  ...
  [PERMISSIONS.REWARDS_VIEW]: 'View EPI Adjustment',
  [PERMISSIONS.REWARDS_ISSUE]: 'Issue EPI Adjustment',
  [PERMISSIONS.REWARDS_MANAGE]: 'Manage EPI Adjustment',
  [PERMISSIONS.PAYSLIPS_VIEW]: 'View Payroll',
  [PERMISSIONS.PAYSLIPS_ISSUE]: 'Issue Payroll',
  [PERMISSIONS.PAYSLIPS_MANAGE]: 'Manage Payroll',
};
