    ...
    >
      ...
      <div className="grid grid-cols-3 divide-x divide-gray-100 bg-white">
        <div className="flex items-center gap-2 px-3 py-3">
          ...
          <div className="min-w-0">
            <p className="text-[10px] font-medium uppercase tracking-wider text-gray-400">Earned</p>
        ...
        <div className="flex items-center gap-2 px-3 py-3">
          <TrendingDown className="h-4 w-4 shrink-0 text-orange-400" />
          <div className="min-w-0">
            <p className="text-[10px] font-medium uppercase tracking-wider text-gray-400">Deducted</p>
            <p className="truncate text-sm font-bold tabular-nums text-orange-500">
              {formatCurrency(wallet.totalDeducted)}
            </p>
          </div>
        </div>
      </div>
